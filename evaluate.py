...
def main():
    ...
    # ตรรกะเลือกแถวอยู่ที่ fs_core ที่เดียว ห้ามสร้างตารางค้นหาเองที่นี่
    #
    # ของเดิมวนสร้าง dict เอง ซึ่งไม่มีเกณฑ์ตัดสินว่า concept ที่โผล่หลายแถว
    # จะเอาค่าจากแถวไหน กลายเป็น "แถวสุดท้ายที่เจอชนะ" ผลคือรายงานว่า
    # สมการไม่ผ่าน 26 ข้อ ขณะที่ crosscheck.py บอกผ่านหมดบนไฟล์เดียวกัน
    # (ทั้งคู่ข้าม 149 ข้อเท่ากันเป๊ะ ต่างกันแค่ค่าที่หยิบมาใส่ตาราง)
    lookup, _ = core.build_equation_lut(ex)
